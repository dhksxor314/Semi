...
<body>
	...
	<%
		...
		totalPage = ((int) Math.ceil((double) totalRecord_s / numPerPage));
	...
	<div id="sidebar">
		<div class="span3">
			<div align="center">
				<img src="upload/${loginImage}" width="110" height="110"><br />
				<h4>${loginName}</h4>
	...
	<form action="front" method="post" id="f">
		<input type="hidden" name="cmd" value="delete_speech" />
		...
		<div class="container" id="main1">
			...
			<div class="span9">
				<ul class="nav nav-tabs">
					<li class="active"><a href="front?cmd=speech">참가한 강연<span
							class="badge badge-info"><%=count_s%></span>
					</a></li>
					...
					<li><a href="front?cmd=complete">완료된 만남<span class="badge"><%=count_c%>
						</span></a></li>
				</ul>
			</div>
						...
						<tbody>
							...
							<%
									...
									for (int i = beginPerPage; i < beginPerPage + numPerPage; i++) {
										if (i == totalRecord_s)
											break;
										Participation_Dto dto = list_s.get(i);
							%>
							<tr>
								<td align="center"><input type="checkbox" name="check"
									value="<%=dto.getPart_num()%>" /></td>
								<td>
									<div class="item-img" style="text-align: center">
										<img src="upload/<%=dto.getImage()%>" width="110" height="110"
											alt="">
									</div>
								</td>
								...
								<td><%=dto.getPrice()%>
									<div class="modal hide fade" id="cencle">
										...
										<div class="modal-body">
											...
											<p style="text-align: left">2. 만남 당일에 결제하시면 취소 및 환불이
												되지않으니 주의 부탁드립니다.</p>
											<p style="text-align: left">3. 만남 당일오전 8시에 개설자가 지정한 최소 인원
												미달 시 취소될 수 있습니다.</p>
										</div>
