	...
	<input type="hidden" id="cmd" name="cmd" value="" /> 
				...
				<table class="div-table table bsk-tbl bg-white" id="table">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center"><%=dto.getPrice()%>
							<input type="hidden" name="price" value="<%=dto.getPrice()%>"/>
							</td>
							<td class="text-center">
								<%int point = dto.getPrice()/100; %> <%=point%>
								<input type="hidden" name="point" value="<%=dto.getPrice()/100%>"/></td>
						</tr>
					</tbody>
					<%
						}
		...
		<div id="order" align="center">
			...
			<div class="btn-group btn-group-justified">
				...
				<div class="btn-group">
					<button class="btn btn-primary" id="req">주문</button>
				</div>
				<div class="btn-group">
				...
				<div class="btn-group btn-group-justified">
					<div class="btn-group">
						<a href="/KnowHowFactory/main.jsp" class="btn">더 담기</a>
					</div>
				</div>
			</div>
		</div>
