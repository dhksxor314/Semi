	...
	$(document).ready(function() {
		$("#req").click(function() {
			if (!$("#password2").val()) {
				...
				alert("비밀번호를 동일하지 않습니다. 다시 입력해주세요.");
				return false;
		...
		<div class="span9">
			...
			<div class="span4.5">
				<form action="front" class="form-horizontal" method="post" id="f"
					...
					<input type="hidden" name="cmd" id="cmd" value="update_member" />
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<label style="float: left"> <input type="radio"
								...
								name="invite_agree" value="<%=dto.getInvite_agree()%>">거부<br />
							</label>
							<%
								} else {
							%>
							<label style="float: left"> <input type="radio"
								...
								value="<%=dto.getInvite_agree()%>">거부<br />
							</label>
							<%
								}
							%>
					...
					<div class="control-group">
						...
						<div class="controls">
							<img src="upload/<%=dto.getImage()%>" width="110" height="100" /><br />
							<br /><strong>* 업로드할 이미지는 영어이름만 가능합니다 </strong><br />
