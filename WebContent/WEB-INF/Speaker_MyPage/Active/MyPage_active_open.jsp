...
<body>
	...
	<%
		...
		String speaker_num = String.valueOf(session.getAttribute("loginMem_num"));
		System.out.println(speaker_num);
		Vector<Speech_Meeting_Dto> list_o = dao.SpeakerOpenList(Integer.parseInt(speaker_num));		
		Vector<Participation_Dto> list_c = dao.CompleteList(Integer.parseInt(speaker_num));
