...
페이지 : 강연자 승인 요청 페이지
작성자 : 전현영
설명 : 강연자로 승인 받기를 원하는 신청자들이 요청이 모두 출력되는 페이지 		
 -->
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="span12">
				<span id="title">강연자 승인</span><br/><br/><br/>
				...
				<div class="pagination">
					...
					<input class="btn pull-right" type="button" value="목록으로" onclick="javascript:location.href='manage?cmd=Speaker_List'"/>				
			</div>
		</div>
	</div>
	<script>
