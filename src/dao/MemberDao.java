...
public class MemberDao {
	...
	public void insertMember(MemberDto dto){ 
		try{		
			...
			String sql = "insert into Member(id, phone, email, point, invite_agree, gender, password, name, birthdate, image) values(?, ?, ?, 0, ?, ?, ?, ?, ?, ?)";
			stmt = con.prepareStatement(sql);
