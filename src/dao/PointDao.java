...
public class PointDao {
	...
	public Vector<MemActivityDto> getActivityList(String keyField, String start, String end, int mem_num){
		...
		String sql = null;				
			...
			sql ="select p2.part_num, p2.post_num, p1.reporting_date, p2.point, s.title, p1.usedpoint, m.point "
					+ " from Participation p1, PointInfo p2, Speech_Meeting s, Member m "
					+ " where p1.part_num=p2.part_num and s.num=p1.num and m.mem_num=p1.mem_num and p1.mem_num="+mem_num;			
