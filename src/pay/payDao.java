...
public class payDao {
	...
	public void insert(int num, String s_m, int paymenttype, int price, int mem_num, int cash) {
		String sql = "insert into Participation(mem_num, s_m, num, reporting_date, payment_option) values(?,?,?,sysdate(),?)";		
		String sql1 = "select part_num from Participation where num=" + num + " and mem_num=" + mem_num;
		
		String sql2 = "insert into PointInfo(mem_num, part_num, point) values(?,?,?)";
